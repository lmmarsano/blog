const reshape = require('reshape')
    , SyncHook = require('tapable').SyncHook

module.exports = function reshapeLoader(source) {
  ...
  // custom plugin hook for options modification
	if (this._compiler.hooks) {
		if (this._compiler.hooks.beforeLoaderProcess) {
			this._compiler.hooks.beforeLoaderProcess.call(options)
		}
	} else {
